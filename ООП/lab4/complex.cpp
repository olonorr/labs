...
// Сложение двух объектов производного класса (метод)
...
// Оператор сложения (производный + производный)
ComplexOperations ComplexOperations::operator+(const ComplexOperations& other) const {
    double newReal = this->getReal() + other.getReal();
    double newImag = this->getImaginary() + other.getImaginary();
    
    std::cout << "\n[Оператор +] Выполняется сложение:" << std::endl;
...
// Оператор вычитания (производный - производный)
ComplexOperations ComplexOperations::operator-(const ComplexOperations& other) const {
    double newReal = this->getReal() - other.getReal();
    double newImag = this->getImaginary() - other.getImaginary();
    
    std::cout << "\n[Оператор -] Выполняется вычитание:" << std::endl;
    std::cout << "  (" << getReal() << " + " << getImaginary() << "i) - ";
    std::cout << "(" << other.getReal() << " + " << other.getImaginary() << "i) = ";
    std::cout << "(" << newReal << " + " << newImag << "i)" << std::endl;
...
// Оператор сравнения == (производный == производный)
bool ComplexOperations::operator==(const ComplexOperations& other) const {
    bool result = (this->getReal() == other.getReal()) && 
                  (this->getImaginary() == other.getImaginary());
    
    std::cout << "\n[Оператор ==] Сравнение:" << std::endl;
    std::cout << "  (" << getReal() << " + " << getImaginary() << "i) == ";
    std::cout << "(" << other.getReal() << " + " << other.getImaginary() << "i) => ";
    std::cout << (result ? "true (числа равны)" : "false (числа не равны)") << std::endl;
...
bool ComplexOperations::operator!=(const ComplexOperations& other) const {
    ...
    std::cout << "  (" << getReal() << " + " << getImaginary() << "i) != ";
    std::cout << "(" << other.getReal() << " + " << other.getImaginary() << "i) => ";
    std::cout << (result ? "true (числа не равны)" : "false (числа равны)") << std::endl;
    
    return result;
}

// Оператор сложения (производный + базовый)
ComplexOperations ComplexOperations::operator+(const ComplexNumber& other) const {
    double newReal = this->getReal() + other.getReal();
    double newImag = this->getImaginary() + other.getImaginary();
    
    std::cout << "\n[Оператор +] Выполняется сложение (произв. + базовый):" << std::endl;
    std::cout << "  (" << getReal() << " + " << getImaginary() << "i) + ";
...
// Оператор вычитания (производный - базовый)
ComplexOperations ComplexOperations::operator-(const ComplexNumber& other) const {
    double newReal = this->getReal() - other.getReal();
    double newImag = this->getImaginary() - other.getImaginary();
    
    std::cout << "\n[Оператор -] Выполняется вычитание (произв. - базовый):" << std::endl;
    std::cout << "  (" << getReal() << " + " << getImaginary() << "i) - ";
    other.printAlgebraicForm();
    std::cout << "  = (" << newReal << " + " << newImag << "i)" << std::endl;
...
// Оператор сравнения == (производный == базовый)
bool ComplexOperations::operator==(const ComplexNumber& other) const {
    bool result = (this->getReal() == other.getReal()) && 
                  (this->getImaginary() == other.getImaginary());
    
    std::cout << "\n[Оператор ==] Сравнение (произв. == базовый):" << std::endl;
    std::cout << "  (" << getReal() << " + " << getImaginary() << "i) == ";
    other.printAlgebraicForm();
...
// Оператор сложения (базовый + производный)
ComplexOperations operator+(const ComplexNumber& left, const ComplexOperations& right) {
    ...
    double newImag = left.getImaginary() + right.getImaginary();
    
    std::cout << "\n[Дружественный оператор +] (базовый + произв.):" << std::endl;
    std::cout << "  ";
    left.printAlgebraicForm();
    std::cout << "  + ";
    right.printAlgebraicForm();
    std::cout << "  = (" << newReal << " + " << newImag << "i)" << std::endl;
    
    return ComplexOperations(newReal, newImag);
}

// Оператор вычитания (базовый - производный)
ComplexOperations operator-(const ComplexNumber& left, const ComplexOperations& right) {
    double newReal = left.getReal() - right.getReal();
    double newImag = left.getImaginary() - right.getImaginary();
...
// Оператор сравнения == (базовый == производный)
bool operator==(const ComplexNumber& left, const ComplexOperations& right) {
    bool result = (left.getReal() == right.getReal()) && 
